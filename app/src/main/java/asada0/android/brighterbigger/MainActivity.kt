...
class MainActivity : Activity(), SensorEventListener {
    ...
    private fun init() {
        ...
        optimizeEdgeToEdge() // 2025/09/05 for Android 15 or later
        // Version Update
    ...
    */
    ...
    private fun setupUIArray() {
        ...
        mStatusLabels = arrayOf(mBinding.textStatusBrighter, mBinding.textStatusBigger, mBinding.textStatusClearer)
